...
function confirmation(alertmessage,variable_name,dictionary_name){
var variable_name = confirm(alertmessage);
if(variable_name){
    dict_modified = dict_modified.concat(dictionary_name)
}
